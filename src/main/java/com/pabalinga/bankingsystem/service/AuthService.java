...
public class AuthService {
    ...
    public int createUser(String username, String password, String role, Integer customerId) throws SQLException {
        return UserDAO.createUser(username, password, role, customerId);
    }
