...
public class AccountDAO {
    ...
    public static List<Account> findAllIncludingClosed() throws SQLException {
        List<Account> list = new ArrayList<>();
    ...
    public static void deleteByAccountNumber(String accountNumber) throws SQLException {
